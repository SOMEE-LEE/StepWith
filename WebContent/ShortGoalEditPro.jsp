...
String repeatCycle = request.getParameter("repeat22");
String repeatType22 = request.getParameter("repeatType22");
String repeatType = "";
...
System.out.println(repeatType22);

if (repeatType22.equals("횟수")){
	repeatType = "횟수-"+request.getParameter("count22")+"회";
	System.out.println(repeatType);
	gdto.setRepeatType(repeatType);
} else if (repeatType22.equals("요일")){
	String names[] = request.getParameterValues("name22");
	...
	System.out.println(repeatType);
	gdto.setRepeatType(repeatType);
} else if (repeatType22.equals("특정 주 요일")) {
	repeatType = "특정 주 요일-"+request.getParameter("week22")+" "+request.getParameter("day22");
	gdto.setRepeatType(repeatType);
} else if (repeatType22.equals("특정 날짜")){
	repeatType = "특정 날짜-"+request.getParameter("month22")+"월 "+request.getParameter("date22")+"일";
	gdto.setRepeatType(repeatType);
} else if (repeatType22.equals("특정 기간")){
	repeatType = "특정 기간-"+request.getParameter("left22")+"일 부터 "+request.getParameter("right22")+"일 까지";
	gdto.setRepeatType(repeatType);
