...
%>
    ...
    <!-- main content가 삽입될 위치 -->
  	...
  	<form action="MyInfoEditPro.jsp" method="post" name="infoEdit"
          class="mb-5" onsubmit="return validateForm(this);">
  		<h2 style="text-align:center; font-size: 24px; font-weight: bold;">내 정보 수정</h2>
  		<br/>
  		 
        <div class="login-join mx-auto my-auto">
<%--         	<div class="mb-4">
        		<label class="col-form-label font-bol">프로필 사진을 추가해보세요</label>
        		<img src="<%= session.getAttribute("ProImg") %>" class="rounded-circle mx-auto d-block">
  				<input class="form-control" type="file" id="profileFile">
        	</div> --%>
        	
<!--         	<div class="mb-4">
        		<label class="col-form-label font-bol">한 줄 자기소개를 작성해 보세요</label>
        		<input type="text" name="about_me" class="form-control formall-width"  
    		...
    		<div class="mb-4">
    			<label class="col-form-label font-bol">아이디</label>
  					...
  					placeholder="<%= dto.getUsermakeId() %>" disabled>
  						
			</div>
			<div class="mb-4">
				<label class="col-form-label font-bol">비밀번호</label>
    			<input type="password" name="userPw"  required 
    			class="form-control formall-width" placeholder="새 비밀번호를 입력하세요"
    			value="<%= dto.getUserPw() %>">
    		</div>
    		<div class="mb-4">
    			<label class="col-form-label font-bol">닉네임</label>
  				<input type="text" name="userNickname" class="form-control formall-width"  
  				placeholder="<%= dto.getUserNickname() %>" disabled>
			</div>
			<div class="mb-4">
    			<label class="col-form-label font-bol">휴대폰</label>
    			<input type="text" name="phoneNumber" class="form-control formall-width"  placeholder="숫자만 입력해주세요"
    			value="<%= dto.getPhoneNumber() %>"  required />
			...
			<div class="mb-4">
			  <label class="col-form-label font-bol">성별</label>
			...
			<div class="mb-4">
				<label class="col-form-label font-bol">생년월일</label>
    		<input type="date" name="birth" class="form-control formall-width">
    		</div>   	
    		
    		<div class="mb-4">
			  <label class="col-form-label font-bol">직업</label>
			   	
			   <div class="form-check">
			   		<input class="form-check-input" type="radio" name="job" id="student">
  					<label class="form-check-label">
    	       		초/중/고등학생
  		    		</label>
			   </div>
			   ...
			   <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="collegeStudent">
  					<label class="form-check-label">
    	       		대학(원)생
  		    		</label>
			   </div>
			   ...
			   <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="officeWorkers">
  					<label class="form-check-label">
    	       		직장인
  		    		</label>
			   </div>
			   ...
			   <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="selfSales">
  					<label class="form-check-label">
    	       		자영업
  		    		</label>
			   </div>
			   ...
			   <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="professional">
  					<label class="form-check-label">
    	       		전문직
  		    		</label>
			   </div>
			   ...
			   <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="housewife">
  					<label class="form-check-label">
    	       		전업주부
  		    		</label>
			   </div>
		       ...
		       <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="unemployed">
  					<label class="form-check-label">
    	       		취업준비생
  		    		</label>
			   </div>
			   ...
			   <div class="form-check">
					<input class="form-check-input" type="radio" name="job" id="etc">
  					<label class="form-check-label">
    	       		기타(직접 작성)
  		    		</label>
			...
			<div class="mb-4">
				<p class="font-bol font-no">관심 분야를 선택해주세요(2개까지 선택 가능)</p>
				<div class="form-check">
        	...
        	<div class="mb-2">
        		...
        		style="width=340px; background-color: #DB6551; border: 0px;" value="수정 완료" />
        	</div>
        	
        	<div class="mb-5">
        		<a href="Withdraw.jsp" class="hyper-text text-end text-hover"><p>회원 탈퇴</p></a>
        	</div>
