...
String repeatCycle = request.getParameter("repeat11");
String repeatType11 = request.getParameter("repeatType11");
String repeatType = "";
...
System.out.println(repeatType11);

if (repeatType11.equals("횟수")){
	repeatType = "횟수-"+request.getParameter("count11")+"회";
	System.out.println(repeatType);
	gdto.setRepeatType(repeatType);
} else if (repeatType11.equals("요일")){
	String names[] = request.getParameterValues("name11");
	...
	System.out.println(repeatType);
	gdto.setRepeatType(repeatType);
} else if (repeatType11.equals("특정 주 요일")) {
	repeatType = "특정 주 요일-"+request.getParameter("week11")+" "+request.getParameter("day11");
	gdto.setRepeatType(repeatType);
} else if (repeatType11.equals("특정 날짜")){
	repeatType = "특정 날짜-"+request.getParameter("month11")+"월 "+request.getParameter("date11")+"일";
	gdto.setRepeatType(repeatType);
} else if (repeatType11.equals("특정 기간")){
	repeatType = "특정 기간-"+request.getParameter("left11")+"일 부터 "+request.getParameter("right11")+"일 까지";
	gdto.setRepeatType(repeatType);
