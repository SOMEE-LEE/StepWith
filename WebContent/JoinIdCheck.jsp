...
int result = mdao.joinIdCheck(usermakeId);
if (result == 1){
...
<fieldset>
	...
	<form action="joinIdCheck.jsp" method="post" name="wfr">
		ID : <input type="text" name="usermake_id" value="<%=usermakeId%>">
...
<!-- 6. 선택된아이디는 중복확인창에서 회원가입 페이지로 정보전달  -->
 <script type="text/javascript">
    function result(){
    	...
    	opener.document.fr.usermake_id.value = document.wfr.usermake_id.value;
