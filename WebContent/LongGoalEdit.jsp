...
MidDownDAO hdao = new MidDownDAO();
Map<String, Object> param = new HashMap<String, Object>(); 
List<MidDownDTO> habitLists = hdao.selectList(param);

// 목표아이디로 목표 목록 받기

UserGoalDTO gdto = gdao.selectGoal(goalId);// goalId로 목표 가져오기 
MidDownDTO hdto = hdao.selectView(midDownId);
...
%>
    ...
    <!-- main content가 삽입될 위치 -->
  	...
  	<form method="post" name="shortEdit"
  		...
  		<h2 style="text-align:center; font-size: 24px; font-weight: bold;">장기 목표 수정</h2>
  		<br/>
        ...
        <input type="hidden" name="goalId" value="<%= gdto.getGoalId() %>" />
				  		<div class="mb-4">
							...
							<input class="form-control" name="goalName33" required disabled
						...
						<div class="mb-4">
				  			...
				  			<div class="d-flex">
					  			<input type="date" name="startDate33" id="startHabit33" class="form-control" 
					  			value="<%= gdto.getStartDate() %>" required disabled>
					  		
					  			<p>&nbsp;~&nbsp;</p>
					  			
					  			<input type="date" name="endDate33" id="endShort33"  class="form-control" 
						...
						<div class="mb-4">
							...
							<div class="form-check mb-2">
								<input class="form-check-input" type="radio" name="repeat33" id="erWeek33"
								value="매주">
				  				<label class="form-check-label">
				    	       		매주
				  		    	</label>										  		    	
							...
							<div class="form-check mb-2">
								<input class="form-check-input" type="radio" name="repeat33" id="erMonth33"
								value="매월">
				  				<label class="form-check-label">
				    	       		매월
				  		    	</label>											  		    	
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" name="repeat33" id="erYear33"
								value="매년">
				  				<label class="form-check-label">
				    	       		매년
				  		    	</label>						    
						...
						<div class="mb-2">
					        ...
					        <div class="form-check mb-2">
					          ...
					          <div class="d-flex">
					              <input class="form-control" id="count33" placeholder="숫자만 입력" name="count33">
					              <label for="count33" class="col-sm-4 col-form-label" >회</label>
					            </div>
					          </div>				  		    	
					        </div>
						 </div>
						  	<div class="form-check mb-2">
					          <input class="form-check-input" type="radio" name="repeatType33" id="weekNday33"
					          onclick="showDiv(this);" value="특정 주, 요일">
					          <label class="form-check-label" for="weekNday33">
					                   특정 주, 요일
					              </label>
					              
					        <div id="weekNday33Box" class="box">
					        <div class="d-flex">
					          <select class="form-select" aria-label="Default select example" id="week33"
					          name="week33">
					            <option>특정 주</option>
					          ...
					          <select class="form-select" aria-label="Default select example" id="day33"
					          name="day33">
					            <option>요일</option>
					        ...
					        <div class="form-check mb-2">
					          <input class="form-check-input" type="radio" name="repeatType33" id="date33"
					          onclick="showDiv(this);" value="특정 날짜">
					            <label class="form-check-label">
					                     특정 날짜
					              </label>
					          <div id="date33Box" class="box">
					          <div class="d-flex ">
					          	  <input class="form-control" id="month33" placeholder="1~12 사이 숫자"
					          	  name="month33">
					          	  <label for="month33" class="col-form-label">월</label>&nbsp;
					              <input class=" form-control" id="date33" placeholder="1~28 사이 숫자"
					              name="date33">
					              <label for="date33" class="col-form-label">일</label>
					          </div>
					          </div>
					        </div>
					
					        <div class="form-check mb-2">
					          <input class="form-check-input" type="radio" name="repeatType33" id="period33"
					          onclick="showDiv(this);" value="특정 기간">
					            <label class="form-check-label">
					                     특정 기간
					              </label>
					        <div id="period33Box" class="box">
		  			...
		  			<%} %>
			  			...
			  			<div>
			        		...
			        		formaction="LongGoalEditPro.jsp"/>
			        	</div>
			    </div>
				</div>
			</form>		
