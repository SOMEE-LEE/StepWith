		      			...
		      			<input type="hidden" name="goalId" value="<%= gdto.getGoalId() %>" />
								...
								<div class="card card-body" style="width: 350px;">
							    	...
							    	<div class="mb-2 row">
								    	...
								    	<div class="col-sm-8">
								      		<textarea class="form-control rounded-2" id="middlePlan3" rows="3"
								      		name="middleGoal3"></textarea>
							    		</div>
							 		</div>
									<div class="mb-2 row">
								    	<label for="lowPlan3" class="col-sm-4 col-form-label">하위 목표</label>
								    	<div class="col-sm-8">
								      		<textarea class="form-control rounded-2" id="lowPlan3" 
								      		name="downGoal3" rows="3"></textarea>
							    		</div>
							 		</div>
							 		<div class="mb-2 row">
								    	<label for="startNum3" class="col-sm-4 col-form-label">시작 수치</label>
								    	<div class="col-sm-4">
								      		<input class="form-control rounded-2" id="startNum3" name="startNum3">
							    		</div>
							 		</div>
							 		<div class="mb-2 row">
								    	<label for="goalNum3" class="col-sm-4 col-form-label">목표 수치</label>
								    	<div class="col-sm-4">
								      		<input class="form-control rounded-2" id="goalNum3" name="goalNum3">
							    		</div>
							 		</div>
							 		<div class="mb-3 row">
								    	<label for="goalUnit3" class="col-sm-4 col-form-label">목표 단위</label>
								    	<div class="col-sm-4">
								      		<input class="form-control rounded-2" id="goalUnit3" name="goalUnit3">
							    		</div>
							 		</div>
							    	...
							    	<div class="mb-2 row">
										...
										<input type="date" id="shortMiddleDate3"
										name="midDate3" class="form-control mx-auto" style="width:320px;">
									</div>
